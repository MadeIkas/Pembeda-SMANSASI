                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom01" name="nama_materi" value="" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom02" value="" name="deskripsi_materi" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
